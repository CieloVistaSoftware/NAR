...
Books, articles, and video cited or referenced across this site's articles.

## Books

**Douglas Geivett & Holly Pivec, *A New Apostolic Reformation? A Biblical Response*** —
the most thorough cessationist theological critique of NAR's apostle/prophet
doctrine.
[Publisher/retail listing](https://www.amazon.com/New-Apostolic-Reformation-Biblical-Worldwide/dp/1941337031).

**Matthew D. Taylor, *The Violent Take It By Force: The Christian Movement That Is
Threatening Our Democracy*** — the most detailed published research connecting
specific NAR apostolic networks to the events of January 6, 2021.
[Publisher's page](https://www.broadleafbooks.com/store/product/9781506497785/The-Violent-Take-It-by-Force).

## Televangelism precedents (Rex Humbard & Oral Roberts)

**Rex Humbard** — [Wikipedia](https://en.wikipedia.org/wiki/Rex_Humbard),
corroborated by [Christian Century's obituary](https://www.christiancentury.org/article/2007-10/rex-humbard-pioneer-tv-evangelist-dies);
the 1970s securities case is documented contemporaneously in
[Christianity Today, "Rex Humbard: 'We Didn't Go Under,'" 1976](https://www.christianitytoday.com/1976/01/rex-humbard-we-didnt-go-under/).

**Oral Roberts** — [Wikipedia](https://en.wikipedia.org/wiki/Oral_Roberts) and
[Britannica](https://www.britannica.com/biography/Oral-Roberts) for biography; the
1987 fundraising appeal and City of Faith's 1989 closure are corroborated by
[CNN's obituary coverage](https://www.cnn.com/2009/US/12/15/oral.roberts/index.html).
His authorship of the foreword to Bill Hamon's *Prophets and Personal Prophecy* —
the direct documented link to NAR's prophetic-apostolic lineage — is confirmed via
bibliographic/retail listing
([Amazon](https://www.amazon.com/Prophets-Personal-Prophecy-Oral-Roberts/dp/0768432618)),
though the foreword's actual text wasn't independently read. A recent academic
biography, reviewed at
[Word&Way](https://wordandway.org/2023/06/27/review-oral-roberts-and-the-rise-of-the-prosperity-gospel/),
cautions against calling Roberts the sole "father" of the prosperity gospel — he's
better described as among its first major popularizers.

## Televangelism networks & healing claims (Kuhlman, CBN/Robertson, TBN, Daystar, Perry Stone)

**Kathryn Kuhlman** — [Wikipedia](https://en.wikipedia.org/wiki/Kathryn_Kuhlman); the
Nolen investigation is documented at
[Wikipedia: William A. Nolen](https://en.wikipedia.org/wiki/William_A._Nolen), corroborating
his 1974 book *Healing: A Doctor in Search of a Miracle*.

**Pat Robertson & CBN** — [Wikipedia](https://en.wikipedia.org/wiki/Pat_Robertson); the
1988 campaign and prediction record via
[NPR](https://www.npr.org/sections/itsallpolitics/2010/09/26/130143774/flashback-friday-on-this-day-in-1987-pat-robertson-announces-white-house-bid),
...
the Carra Crouch verdict via
[CBS Los Angeles](https://www.cbsnews.com/losangeles/news/trinity-broadcasting-granddaughter-jury-award/).

**Daystar Television Network** — [Wikipedia](https://en.wikipedia.org/wiki/Daystar_Television_Network);
the 2010 affair/extortion disclosure via
[CBS News](https://www.cbsnews.com/news/marcus-lamb-televangelist-announces-extortion-over-affair/);
Marcus Lamb's death via
[Christianity Today](https://www.christianitytoday.com/2021/12/obit-marcus-lamb-daystar-tv-success-scandal/);
Joni Lamb's 2026 death and leadership dispute via
[Religion News Service](https://religionnews.com/2026/05/07/4258241/).

**Perry Stone** — [Wikipedia](https://en.wikipedia.org/wiki/Perry_Stone); the ISIS
sleeper-cell and Watergate/Russia-collusion claims via
[Jim Bakker Show](https://jimbakkershow.com/news/perry-stone-issues-terror-alert/);
the COVID-19 remarks via
[Chattanooga Times Free Press](https://www.timesfreepress.com/news/life/faith/story/2020/mar/21/evangelist-perry-stone-coronavirus/518788/);
the misconduct allegations and grand jury outcome via the same paper's
[December 2021](https://www.timesfreepress.com/news/local/story/2021/dec/25/women-perry-stones-ministry-allege-sexual-mis/560366/)
and [April 2023](https://www.timesfreepress.com/news/2023/apr/03/bradley-grand-jury-declines-charge-perry-stone-tfp/)
reporting.

**On the absence of documented healings** — James Randi, *The Faith Healers*
(Prometheus Books, 1987), summarized at
[Wikipedia](https://en.wikipedia.org/wiki/The_Faith_Healers); the Peter Popoff
...
[rightwingwatch.org/organizations/new-apostolic-reformation](https://www.rightwingwatch.org/organizations/new-apostolic-reformation/)
(a project of People For the American Way).

**Rolling Stone**:
- ["How the Christian Right Helped Foment Insurrection"](https://www.rollingstone.com/culture/culture-features/capitol-christian-right-trump-1121236/)
- ["Meet Dutch Sheets, the Right-Wing Apostle of Christian Nationalism"](https://www.rollingstone.com/politics/politics-news/new-apostolic-reformation-mtg-mastriano-dutch-sheets-1234584952/)

**Vice** — no article specifically and substantively about the NAR could be
confidently located as of this writing. A piece sometimes surfaced in searches
("Why evangelicals are 'ecstatic' about Trump's Jerusalem move") is about End Times
prophecy generally, not NAR structure or leadership, and isn't cited here as a result.
If a reader knows of a real Vice article specifically on NAR, it's worth flagging as
an issue to add.

## Video

This is the weakest-sourced category, and that's stated plainly rather than papered
over. The January 6, 2021 shofar-blowing and prophetic-rhetoric footage that
journalists (including Rolling Stone's reporting above) have referenced was, as best
as could be confirmed, provided to reporters privately by researchers rather than
posted at one stable public URL. A video exists on the Internet Archive
(["Blowing shofar and putting up Cross message of Jesus at Capitol"](https://archive.org/details/44pTivX5qsChW8x35),
uploaded January 8, 2021) — it is real and live, but it's self-described by its
uploader as part of a pro-Trump "documentary... exposing the fraud," i.e. a partisan
participant's own footage, not something independently verified or specifically
cited by name in the journalism above. Treat it as illustrative at best, not as a
primary source.

For official ministry video (not journalism), Bethel Church's own YouTube channel is
linked directly from [bethel.com](https://www.bethel.com/), and Generals International
runs its own platform at [tv.generals.org](https://tv.generals.org/) — both are the
subjects' own self-presentation, not independent reporting, and are cited here as
such.

## A note on how this list was built

Every link on this page and on [People](/public/doc-viewer.html?file=docs%2Fpeople.md) was checked at the time this
page was written — searched for, confirmed live, and cross-checked for name
collisions or defunct organizations — not reconstructed from memory. Where a
confident, verifiable link couldn't be found, that's stated instead of guessing.
If any link here goes dead or turns out to be wrong, that's a real bug: file it on
the [Issues](?page=issues) page.
